...
from amundsen_application.api.utils.cloudflare import verify_token, get_authenticated_user_email, get_first_name
...
def current_user() -> Response:
    print(verify_token())
    auth_user_email = get_authenticated_user_email()
    first_name = get_first_name(auth_user_email)
