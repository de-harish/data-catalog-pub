...
const PRODUCT_TOUR_BUTTON_TEXT = 'Discover talabat data catalog';
const APP_SUITE_BUTTON_TEXT = 'Related Apps';
export const HOMEPAGE_PATH = '/';
const AVATAR_SIZE = 32;

const GENERIC_LIGHT_LOGO_PATH = '/static/images/logo.svg';
const GENERIC_DARK_LOGO_PATH = '/static/images/logo.svg';
