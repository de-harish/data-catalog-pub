...
AppConfig.logoTitle = 'talabat data catalog';
AppConfig.navLinks = [
  {
    label: 'Browse',
    href: '/browse',
      ...
      steps: [
        {
          ...
          title: 'Welcome to talabat Data catalog',
          content:
            'Hi!, welcome to talabat Data catalog, your data discovery and catalog product!',
        },
        {
