...
"""
This is a script for extracting BigQuery metadata results
"""
...
def create_bq_job(metadata_type, gcloud_project):
    ...
    job_config = ConfigFactory.from_dict({
        ...
        f'extractor.bigquery_table_metadata.{BigQueryMetadataExtractor.FILTER_KEY}': 'labels.catalog:true', #filter desired datasets only
...
if __name__ == "__main__":
    ...
    bq_metadata_extract_job = create_bq_job('bigquery_metadata', 'tlb-data-prod')
    bq_metadata_extract_job.launch()
