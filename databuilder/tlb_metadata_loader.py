...
if __name__ == "__main__":
    ...
    #tlb
    run_table_column_job('tlb_extracted_metadata/table.csv', 'tlb_extracted_metadata/col.csv')
    ...
    #tlb
    run_table_lineage_job('tlb_extracted_metadata/table_lineage.csv')
    run_column_lineage_job('example/sample_data/sample_column_lineage.csv')
    #tlb
    #run_column_lineage_job('tlb_extracted_metadata/column_lineage.csv')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/watermark.csv', 'watermark_metadata',
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/table_owner.csv', 'tlb_table_owner_metadata',
                'databuilder.models.table_owner.TableOwner')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/column_usage.csv', 'tlb_usage_metadata',
                'databuilder.models.table_column_usage.ColumnReader')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/airflow_metadata.csv', 'tlb_airflow_metadata',
                'databuilder.models.application.Application')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/source.csv', 'tlb_source_metadata',
                'databuilder.models.table_source.TableSource')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/table_last_updated.csv', 'tlb_table_last_updated_metadata',
                'databuilder.models.table_last_updated.TableLastUpdated')
    ...
    # tlb
    run_csv_job('tlb_extracted_metadata/schema_description.csv', 'tlb_schema_description',
                'databuilder.models.schema.schema.SchemaModel')
